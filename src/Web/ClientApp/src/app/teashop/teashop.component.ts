...
@Component({
  selector: 'app-teashop-component',
  templateUrl: './teashop.component.html',
  styleUrls: ['./teashop.component.scss']
})
export class TeaShopComponent implements OnInit {
  query: GetProductsWithPaginationQuery = {
    query: "",
    pageNumber: 1,
    pageSize: 100
  };
  ...
  ngOnInit(): void {
    // TODO: How do I get a query string into here?
    this.productsClient.getProductsWithPagination(this.queryString, 1, 100).subscribe(
      result => {
